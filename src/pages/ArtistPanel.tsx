              ...
              <div className="mt-3 space-y-4">
                <Card className="border-primary/30 bg-primary/5">
                  ...
                  <CardContent className="p-3 pt-0 sm:p-6 sm:pt-0 space-y-2 text-xs sm:text-sm text-muted-foreground">
                    <p>
                      Os pagamentos são processados de forma segura e creditados na conta da plataforma.
                    </p>
                    <ul className="list-disc list-inside space-y-1 ml-1 text-xs">
                      <li><strong>Plano Free:</strong> Receba 80% das gorjetas (20% taxa)</li>
                      <li><strong>Plano Pro:</strong> Receba 100% das gorjetas (0% taxa)</li>
                      <li><strong>PIX Direto (Pro):</strong> Receba instantaneamente</li>
                    </ul>
                  </CardContent>
                </Card>
              </div>
