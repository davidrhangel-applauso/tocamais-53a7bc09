...
• **Artistas Pro (a partir de R$${formatPrice(prices.mensal)}/mês):** Taxa de 0% (você recebe 100% da gorjeta)
...
• **Mensal:** R$ ${formatPrice(prices.mensal)}/mês
• **Anual:** R$ ${formatPrice(prices.anual)}/ano (R$ ${formatPrice(prices.anualMonthly)}/mês)
• **Bienal:** R$ ${formatPrice(prices.bienal)}/2 anos (R$ ${formatPrice(prices.bienalMonthly)}/mês)
...
• **Pro:** R$100 em gorjetas = R$100 líquido - R$${formatPrice(prices.mensal)} = R$${formatPrice(100 - prices.mensal)} líquido
