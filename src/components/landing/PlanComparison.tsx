    ...
    <section className="py-16 sm:py-24 px-4 bg-gradient-to-b from-muted/30 to-background">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-card border border-border rounded-2xl shadow-xl relative overflow-visible">
          ...
          <Badge className="absolute top-0 right-[calc(100%/6)] translate-x-1/2 -translate-y-1/2 bg-green-500 text-white border-0 z-10">
            Recomendado
          </Badge>
          {/* Header */}
          <div className="grid grid-cols-3 rounded-t-2xl overflow-hidden">
            ...
            <div className="p-4 sm:p-6 text-center border-l border-primary/50 bg-gradient-to-br from-primary/10 to-accent/10">
